...
private:	
	...
	void ngx_close_connection(lpngx_connection_t pConn);                  //通用连接关闭函数，释放资源
...
private:
	...
	//lpngx_connection_t             m_pfree_connections;                //空闲连接链表头;指向的都是m_pconnections连接池里的没有被使用的成员
